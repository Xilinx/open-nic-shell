...
##################################################################
# CREATE IP cpl_axis_interconnect_1
##################################################################

set cpl_axis_interconnect_1 cpl_axis_interconnect_1
create_ip -name axis_interconnect -vendor xilinx.com -library ip -module_name cpl_axis_interconnect_1 -dir ${ip_build_dir}
...
] [get_ips cpl_axis_interconnect_1]

# Runtime Parameters
#set_property -dict { 
#  GENERATE_SYNTH_CHECKPOINT {1}
#} $cpl_axis_interconnect_1
