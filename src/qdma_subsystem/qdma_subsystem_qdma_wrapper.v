...
module qdma_subsystem_qdma_wrapper (
  ...
  qdma_no_sriov qdma_inst (
    ...
    .usr_irq_in_vld                       (1'b0),                                // input wire usr_irq_in_vld
    .usr_irq_in_vec                       (0),                                   // input wire [4 : 0] usr_irq_in_vec
    .usr_irq_in_fnc                       (0),                                   // input wire [7 : 0] usr_irq_in_fnc
    .usr_irq_out_ack                      (),                                    // output wire usr_irq_out_ack
    .usr_irq_out_fail                     (),                                    // output wire usr_irq_out_fail

    .st_rx_msg_rdy                        (1'b1),                                // input wire st_rx_msg_rdy
    .st_rx_msg_valid                      (),                                    // output wire st_rx_msg_valid
    .st_rx_msg_last                       (),                                    // output wire st_rx_msg_last
    .st_rx_msg_data                       (),                                    // output wire [31 : 0] st_rx_msg_data
    ...
    .cfg_max_read_req                     (),                                    // output wire [2 : 0] cfg_max_read_req
    .cfg_max_payload                      (),                                    // output wire [1 : 0] cfg_max_payload
    .cfg_flr_in_process                   (),                                    // output wire [3 : 0] cfg_flr_in_process
    .cfg_vf_flr_in_process                (),                                    // output wire [251 : 0] cfg_vf_flr_in_process
