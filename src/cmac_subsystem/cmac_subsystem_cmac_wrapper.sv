...
module cmac_subsystem_cmac_wrapper #(
  ...
  output     [NUM_CMAC_PORT-1:0] m_axis_rx_tvalid,
  output [512*NUM_CMAC_PORT-1:0] m_axis_rx_tdata,
  output  [64*NUM_CMAC_PORT-1:0] m_axis_rx_tkeep,
  output     [NUM_CMAC_PORT-1:0] m_axis_rx_tlast,
  output     [NUM_CMAC_PORT-1:0] m_axis_rx_tuser_err,

  input      [NUM_CMAC_PORT-1:0] s_axis_tx_tvalid,
  input  [512*NUM_CMAC_PORT-1:0] s_axis_tx_tdata,
  input   [64*NUM_CMAC_PORT-1:0] s_axis_tx_tkeep,
  input      [NUM_CMAC_PORT-1:0] s_axis_tx_tlast,
  input      [NUM_CMAC_PORT-1:0] s_axis_tx_tuser_err,
  output     [NUM_CMAC_PORT-1:0] s_axis_tx_tready,

  input      [NUM_CMAC_PORT-1:0] gt_refclk_p,
  input      [NUM_CMAC_PORT-1:0] gt_refclk_n,
  output     [NUM_CMAC_PORT-1:0] cmac_clk,
  input      [NUM_CMAC_PORT-1:0] cmac_sys_reset,

  input                          axil_aclk
);

  generate for (genvar i = 0; i < NUM_CMAC_PORT; i++) begin: cmac_wrapper
...
`ifdef __zynq_family__
        .gt0_rxp_in                          (gt_rxp[`getbit(4, i, 0)]),
        .gt0_rxn_in                          (gt_rxn[`getbit(4, i, 0)]),
        .gt1_rxp_in                          (gt_rxp[`getbit(4, i, 1)]),
        .gt1_rxn_in                          (gt_rxn[`getbit(4, i, 1)]),
        .gt2_rxp_in                          (gt_rxp[`getbit(4, i, 2)]),
        .gt2_rxn_in                          (gt_rxn[`getbit(4, i, 2)]),
        .gt3_rxp_in                          (gt_rxp[`getbit(4, i, 3)]),
        .gt3_rxn_in                          (gt_rxn[`getbit(4, i, 3)]),
        .gt0_txp_out                         (gt_txp[`getbit(4, i, 0)]),
        .gt0_txn_out                         (gt_txn[`getbit(4, i, 0)]),
        .gt1_txp_out                         (gt_txp[`getbit(4, i, 1)]),
        .gt1_txn_out                         (gt_txn[`getbit(4, i, 1)]),
        .gt2_txp_out                         (gt_txp[`getbit(4, i, 2)]),
        .gt2_txn_out                         (gt_txn[`getbit(4, i, 2)]),
        .gt3_txp_out                         (gt_txp[`getbit(4, i, 3)]),
        .gt3_txn_out                         (gt_txn[`getbit(4, i, 3)]),
`else
        .gt_rxp_in                           (gt_rxp[`getvec(4, i)]),
        .gt_rxn_in                           (gt_rxn[`getvec(4, i)]),
        .gt_txp_out                          (gt_txp[`getvec(4, i)]),
        .gt_txn_out                          (gt_txn[`getvec(4, i)]),
`endif
        ...
        .gt_ref_clk_p                        (gt_refclk_p[i]),
        .gt_ref_clk_n                        (gt_refclk_n[i]),
        .gt_ref_clk_out                      (),
        .gt_rxrecclkout                      (),
        .gt_rxusrclk2                        (),
        .rx_clk                              (txusrclk2),
        ...
        .s_axi_sreset                        (cmac_sys_reset[i]),

        .s_axi_awvalid                       (s_axil_awvalid[i]),
        .s_axi_awaddr                        (s_axil_awaddr[`getvec(32, i)]),
        .s_axi_awready                       (s_axil_awready[i]),
        .s_axi_wvalid                        (s_axil_wvalid[i]),
        .s_axi_wdata                         (s_axil_wdata[`getvec(32, i)]),
        .s_axi_wstrb                         (4'hF),
        .s_axi_wready                        (s_axil_wready[i]),
        .s_axi_bvalid                        (s_axil_bvalid[i]),
        .s_axi_bresp                         (s_axil_bresp[`getvec(2, i)]),
        .s_axi_bready                        (s_axil_bready[i]),
        .s_axi_arvalid                       (s_axil_arvalid[i]),
        .s_axi_araddr                        (s_axil_araddr[`getvec(32, i)]),
        .s_axi_arready                       (s_axil_arready[i]),
        .s_axi_rvalid                        (s_axil_rvalid[i]),
        .s_axi_rdata                         (s_axil_rdata[`getvec(32, i)]),
        .s_axi_rresp                         (s_axil_rresp[`getvec(2, i)]),
        .s_axi_rready                        (s_axil_rready[i]),

        .rx_axis_tvalid                      (m_axis_rx_tvalid[i]),
        .rx_axis_tdata                       (m_axis_rx_tdata[`getvec(512, i)]),
        .rx_axis_tkeep                       (m_axis_rx_tkeep[`getvec(64, i)]),
        .rx_axis_tlast                       (m_axis_rx_tlast[i]),
        .rx_axis_tuser                       (m_axis_rx_tuser_err[i]),
        .rx_preambleout                      (rx_preambleout),

        .tx_axis_tvalid                      (s_axis_tx_tvalid[i]),
        .tx_axis_tdata                       (s_axis_tx_tdata[`getvec(512, i)]),
        .tx_axis_tkeep                       (s_axis_tx_tkeep[`getvec(64, i)]),
        .tx_axis_tlast                       (s_axis_tx_tlast[i]),
        .tx_axis_tuser                       (s_axis_tx_tuser_err[i]),
        .tx_axis_tready                      (s_axis_tx_tready[i]),
        .tx_ovfout                           (tx_ovfout),
        .tx_unfout                           (tx_unfout),
