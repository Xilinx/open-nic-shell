...
`endif
  ...
  wire  [16*NUM_PHYS_FUNC-1:0] axis_qdma_c2h_tuser_use_rss;
  wire  [16*NUM_PHYS_FUNC-1:0] axis_qdma_c2h_tuser_c2h_qid;   
  ...
  wire  [16*NUM_CMAC_PORT-1:0] axis_adap_rx_250mhz_tuser_use_rss;
  wire  [16*NUM_CMAC_PORT-1:0] axis_adap_rx_250mhz_tuser_c2h_qid;   
...
`endif
  ...
  qdma_subsystem #(
    ...
    .s_axis_c2h_tuser_use_rss             (axis_qdma_c2h_tuser_use_rss),
    .s_axis_c2h_tuser_c2h_qid             (axis_qdma_c2h_tuser_c2h_qid),
...
`endif
  ...
  generate for (genvar i = 0; i < NUM_CMAC_PORT; i++) begin: cmac_port
    packet_adapter #(
      ...
      .m_axis_rx_tuser_use_rss (axis_adap_rx_250mhz_tuser_use_rss[`getvec(16, i)]),
      .m_axis_rx_tuser_c2h_qid (axis_adap_rx_250mhz_tuser_c2h_qid[`getvec(16, i)]),
...
`endif
  ...
  box_250mhz #(
    ...
    .m_axis_qdma_c2h_tuser_use_rss    (axis_qdma_c2h_tuser_use_rss),
    .m_axis_qdma_c2h_tuser_c2h_qid    (axis_qdma_c2h_tuser_c2h_qid),
